...
class TutoLevel extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            level: props.level
                ...
                <svg key={ uuid() } width="50" height="50" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_414_967)">
                        <path
                            ...
                            stroke={ i <= this.state.level?color:defaultColor } strokeMiterlimit="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path fillRule="evenodd" clipRule="evenodd"
                            ...
                            fill={ i <= this.state.level?color:defaultColor } />
                    </g>
                    <defs>
